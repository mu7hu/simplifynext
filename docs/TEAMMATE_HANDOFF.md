...
- `ExperimentPlan` in `src/augury/schemas/experiment.py`: strategist output passed to execution and analysis.
- `ExperimentResult` in `src/augury/schemas/result.py`: normalized result passed to analysis and the ledger.
- `AnalysisReport` in `src/augury/schemas/analysis.py`: analyst output passed to validation, ledger, digest, and the next planning cycle.
...
- Location: `src/augury/agents/analyst.py`
...
- Existing stub: `StubAnalystAgent`, backed by the deterministic local model in `src/augury/models.py`.
- Preserve: `tests/test_analyst.py` and `tests/test_graph.py`.
- Called from: `node_analyst` in `src/augury/graph/nodes.py`, after execution and measurement.
...
- Location: `src/augury/services/measurement.py`
...
- Location: `src/augury/services/intake.py`
...
- Location: `src/augury/services/profiler.py`
...
- Location: `src/augury/services/execution.py`
- Existing stub: `SimulatedExecutionService`, backed by `MarketSimulator` in `src/augury/simulator/market.py`.
...
- Location: `src/augury/services/digest.py`
