"""LangGraph node implementations for Augury."""
...
from augury.constraints.budget import validate_plan_constraints, rebalance_micro_cents
from augury.approval.base import ApprovalAction


def node_load_context(state: AuguryGraphState, ledger, profiler, intake) -> dict[str, Any]:
...
def node_strategist(state: AuguryGraphState, strategist_agent, ledger) -> dict[str, Any]:
...
def node_validate_plan(state: AuguryGraphState) -> dict[str, Any]:
...
def node_strategist_repair(state: AuguryGraphState, strategist_agent) -> dict[str, Any]:
...
def node_approval_gate(state: AuguryGraphState, approval_gate) -> dict[str, Any]:
...
def node_founder_revision(state: AuguryGraphState) -> dict[str, Any]:
...
def node_execute(state: AuguryGraphState, execution_service) -> dict[str, Any]:
...
def node_measure(state: AuguryGraphState, measurement_service) -> dict[str, Any]:
...
def node_analyst(state: AuguryGraphState, analyst_agent) -> dict[str, Any]:
...
def node_validate_analysis(state: AuguryGraphState) -> dict[str, Any]:
...
def node_persist_ledger(state: AuguryGraphState, ledger) -> dict[str, Any]:
...
def node_generate_digest(state: AuguryGraphState, digest_service) -> dict[str, Any]:
