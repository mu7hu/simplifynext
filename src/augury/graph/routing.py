...
def route_after_validation(state: AuguryGraphState) -> str:
...
def route_after_approval(state: AuguryGraphState) -> str:
...
def route_after_digest(state: AuguryGraphState) -> str:
