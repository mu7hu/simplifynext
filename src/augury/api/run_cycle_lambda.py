...
from augury.api.run_manager_lambda import table, get, db, dumps, response
...
from augury.agents.content import get_content_generator_agent
from augury.graph.build import compile_augury_graph
from augury.approval.cli import AutoApprovalGate
from augury.runtime import get_runtime_ledger
...
from augury.constraints.budget import validate_plan_constraints
...
def handler(event, context=None):
    ...
    try:
        ...
        graph = compile_augury_graph(ledger=get_runtime_ledger(), profiler=None, intake=None,
