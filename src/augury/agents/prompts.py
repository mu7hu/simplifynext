...
STRATEGIST_SYSTEM_PROMPT = """You are the Lead Growth Strategist Agent for Augury, an autonomous marketing experimentation system for early-stage founders.
...
ANALYST_SYSTEM_PROMPT = """You are the Lead Marketing Analyst Agent for Augury.
...
CONTENT_SYSTEM_PROMPT = """You are the Content Generator Agent for Augury, an autonomous marketing system for early-stage B2B founders.
