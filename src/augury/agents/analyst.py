...
(``augury.api.analyst_lambda``) and the CLI (``scripts/run_analyst.py``) all get
...
from augury.models import ModelFactory, get_analyst_model, get_analyst_structured_model
...
from augury.agents.prompts import ANALYST_SYSTEM_PROMPT, ANALYST_HUMAN_PREAMBLE
