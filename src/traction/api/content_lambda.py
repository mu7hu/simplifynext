...
Same shape as ``traction.api.analyst_lambda``: a separate deployable service that
imports nothing from ``traction.graph`` / the supervisor / other agents. Deploy
...
from traction.agents.content import ContentGeneratorAgent, BedrockContentGeneratorAgent
