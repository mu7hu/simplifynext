"""Structured observability and event logging for Traction."""
...
def get_logger(name: str = "traction") -> logging.Logger:
    """Obtain a structured logger configured for Traction."""
